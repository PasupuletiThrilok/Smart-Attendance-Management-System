...
dataset_path = "C:/Users/hp/PycharmProjects/MLDL_projects/dataset"
...
log_file_path = 'C:/Users/hp/PycharmProjects/MLDL_projects/log.csv'
    ...
    if request.method == 'POST':
        ...
        if entered_code == SECRET_CODE:
            ...
            if name in dataset:
                ...
                message = "Your name is not in the dataset. Please contact your class teacher and register your face ID."
                message_class = "error"
        else:
            message = "Unauthorized access! Please enter the correct code to mark attendance."
            message_class = "error"
    else:
        message = ""
        message_class = ""

    return render_template('attendance_form.html', message=message, message_class=message_class)
...
def check_notifications():
    # Dummy function to return some notifications (modify as needed)
    notifications = {
        'notification': 'This is a sample notification. Modify the check_notifications() function to handle real notifications.'
    }
